#ifndef OmniKinematics_h
#define OmniKinematics_h
#include <math.h>
...
WheelTargets omni_ik(float vx, float vy, float omega) {
...
void calculate_position_error(float x_curr, float y_curr, float theta_curr,
...
void updateOdometry(float d_fl, float d_fr, float d_rl, 
